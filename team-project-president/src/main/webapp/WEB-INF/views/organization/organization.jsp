...
<body>
    ...
    <section class="cont_view">
        <div class="contents_tab">
            <div class="contents_tab_li" id="on"><a href="/about/organization" class="tab_menu">청와대 조직도</a></div>
            <div class="contents_tab_li"><a href="/about/government-organization" class="tab_menu" id="tab_center">정부 조직도</a></div>
            <div class="contents_tab_li"><a href="/about/history" class="tab_menu">청와대 소개 및 역사</a></div>
        </div>
        <div class="cont_area">
            <div class="cont_body">
                <div class="wrap">
                    <img src="/image/organization_chart.png" alt="">
                </div>
            </div>
            <div class="mark_wrap">
                <div class="mark_btn">
